...
setup(name             = 'calandigital',
      ...
      license          = 'GPL v3',
      packages         = [pack.replace('source', 'calandigital') for pack in find_packages()],
      package_dir      = {pack.replace('source', 'calandigital') : pack.replace('.', '/') for pack in find_packages()},
